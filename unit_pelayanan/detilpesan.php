<?php  
    ...
    if (isset($_GET['tgl'])) {
        $tgl = $_GET['tgl'];
        $query = mysqli_query($koneksi, "SELECT id_permintaan, kode_brg, nama_barang, jumlah,jenis_barang, status, keterangan FROM permintaan 
        WHERE tgl_permintaan='$tgl' AND unit='$_SESSION[username]' ");
